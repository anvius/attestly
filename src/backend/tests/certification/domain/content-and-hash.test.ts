...
import { calculateContentHash } from "../../../certification/domain/calculate-content-hash";
...
describe("calculateContentHash", () => {
  ...
  it("matches hash for equivalent text and bytes", async () => {
    ...
    const textHash = await calculateContentHash(textContent);
    const fileHash = await calculateContentHash(fileContent);
